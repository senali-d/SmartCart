    ...
    <>
      ...
      <>
        <div className="pt-[70px]">
          <BackgroundVideo video="/background-video1.mp4" />
            ...
            <div className="md:text-left  flex justify-center flex-row">
              <div className="flex flex-col justify-center">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  ...
                  <span className="block text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-ornage-900 pb-4">
                    Smart Cart
                  </span>
